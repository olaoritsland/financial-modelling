...
interest_bearing_assets <- c("bank_deposits_cash_etc",              # keep 10% of ...?
                             ...
                             #"total_financial_fixed_assets",
                             "bonds",
                             "receivables_to_companies_in_the_same_group",
                             "shares_and_interests_in_group_companies",
...
data <- readxl::read_xlsx(file, sheet = "Mother accounting", skip = 2) 
...
# Sjekk at alle linjer kommer med (like navn)
# Test balansesum (ordinær og omorganisert)